    ...
    <>
      ...
      <nav className="justify-center flex bg-yellow-400 py-3">
        <a href="https://www.facebook.com/" className="inline-block p-2">
          ...
          <img
            src="https://www.trihealth.com/images/external-link.png"
        ...
        <a href="https://www.instagram.com/" className="inline-block p-2">
          <svg
            ...
            viewBox="0 0 448 512"
            aria-describedby="Instagram Logo"
            className="w-auto h-6 fill-indigo-950 inline-block"
          >
      ...
      <div className="bg-indigo-950 text-white px-3 pb-4">
        ...
        <strong className="text-xs">
          Four Seasons Population Health Organization (FSPHO)
        </strong>
        <p className="text-xs">
          The Fur Seasons Population Health Organization (FSPHO) proudly
          provides easily accessible and inclusive care to people of all ages,
          backgrounds, demographics, and walks of life.
          <br />
          We look forward to offering high-quality, cost-effective health
          services - everyone is welcome here.
        </p>
